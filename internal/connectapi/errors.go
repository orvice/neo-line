...
func toConnectError(err error) error {
	...
	case errors.Is(err, store.ErrGroupNameTaken), errors.Is(err, store.ErrNotifyGroupNameTaken), errors.Is(err, store.ErrDNSProviderAccountNameTaken), errors.Is(err, store.ErrCertificateIssuerNameTaken):
	...
	case errors.Is(err, store.ErrInvalidDNSProvider), errors.Is(err, store.ErrInvalidPropagationTimeout), errors.Is(err, certmanager.ErrTokenRequired):
		return connect.NewError(connect.CodeInvalidArgument, err)
	case errors.Is(err, store.ErrInvalidCertificateIssuerCAType), errors.Is(err, certmanager.ErrIssuerNameRequired), errors.Is(err, certmanager.ErrIssuerEmailRequired), errors.Is(err, certmanager.ErrTermsOfServiceRequired), errors.Is(err, certmanager.ErrEABRequired), errors.Is(err, certmanager.ErrCustomDirectoryRequired), errors.Is(err, certmanager.ErrInvalidDirectoryURL), errors.Is(err, certmanager.ErrIssuerRegistrationPending):
		return connect.NewError(connect.CodeInvalidArgument, err)
	case errors.Is(err, store.ErrCertificateIssuerImmutable):
