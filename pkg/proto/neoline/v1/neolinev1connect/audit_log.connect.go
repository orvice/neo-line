...
const (
	...
	AuditLogServiceName = "neoline.v1.AuditLogService"
)
...
const (
	...
	// ListAuditLogs RPC.
	AuditLogServiceListAuditLogsProcedure = "/neoline.v1.AuditLogService/ListAuditLogs"
)

// AuditLogServiceClient is a client for the neoline.v1.AuditLogService service.
...
// NewAuditLogServiceClient constructs a client for the neoline.v1.AuditLogService service. By
...
func NewAuditLogServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) AuditLogServiceClient {
	...
	auditLogServiceMethods := v1.File_neoline_v1_audit_log_proto.Services().ByName("AuditLogService").Methods()
...
// ListAuditLogs calls neoline.v1.AuditLogService.ListAuditLogs.
...
// AuditLogServiceHandler is an implementation of the neoline.v1.AuditLogService service.
...
func NewAuditLogServiceHandler(svc AuditLogServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/neoline.v1.AuditLogService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedAuditLogServiceHandler) ListAuditLogs(context.Context, *connect.Request[v1.ListAuditLogsRequest]) (*connect.Response[v1.ListAuditLogsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("neoline.v1.AuditLogService.ListAuditLogs is not implemented"))
}
